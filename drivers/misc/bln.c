...
#define MAX_ALLOWED_BLINK_INTERVAL      10000      /* MAX 10000 milliseconds = 10 seconds */
...
#endif
static uint bln_blink_interval_on = 10;          /* Interval in milliseconds for blink ON (default: 10 ms) */
static uint bln_blink_interval_off = 500;         /* Interval in milliseconds for blink OFF (default: 500 ms) */
static uint bln_blink_max_time = 3600;              /* Timeout in seconds for in-kernel blinking (default: 1 hour) */
